...
// Source: /HOME/USER/go/src/github.com/gardener/machine-controller-manager-provider-azure/vendor/github.com/Azure/azure-sdk-for-go/services/network/mgmt/2021-05-01/network/networkapi/interfaces.go
...
import (
	...
	network "github.com/Azure/azure-sdk-for-go/services/network/mgmt/2021-05-01/network"
...
// UpdateTags mocks base method.
func (m *MockBastionHostsClientAPI) UpdateTags(ctx context.Context, resourceGroupName, bastionHostName string, parameters network.TagsObject) (network.BastionHostsUpdateTagsFuture, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateTags", ctx, resourceGroupName, bastionHostName, parameters)
	ret0, _ := ret[0].(network.BastionHostsUpdateTagsFuture)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdateTags indicates an expected call of UpdateTags.
func (mr *MockBastionHostsClientAPIMockRecorder) UpdateTags(ctx, resourceGroupName, bastionHostName, parameters interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateTags", reflect.TypeOf((*MockBastionHostsClientAPI)(nil).UpdateTags), ctx, resourceGroupName, bastionHostName, parameters)
}
...
// MockFirewallPolicyIdpsSignaturesClientAPI is a mock of FirewallPolicyIdpsSignaturesClientAPI interface.
type MockFirewallPolicyIdpsSignaturesClientAPI struct {
	ctrl     *gomock.Controller
	recorder *MockFirewallPolicyIdpsSignaturesClientAPIMockRecorder
}

// MockFirewallPolicyIdpsSignaturesClientAPIMockRecorder is the mock recorder for MockFirewallPolicyIdpsSignaturesClientAPI.
type MockFirewallPolicyIdpsSignaturesClientAPIMockRecorder struct {
	mock *MockFirewallPolicyIdpsSignaturesClientAPI
}

// NewMockFirewallPolicyIdpsSignaturesClientAPI creates a new mock instance.
func NewMockFirewallPolicyIdpsSignaturesClientAPI(ctrl *gomock.Controller) *MockFirewallPolicyIdpsSignaturesClientAPI {
	mock := &MockFirewallPolicyIdpsSignaturesClientAPI{ctrl: ctrl}
	mock.recorder = &MockFirewallPolicyIdpsSignaturesClientAPIMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockFirewallPolicyIdpsSignaturesClientAPI) EXPECT() *MockFirewallPolicyIdpsSignaturesClientAPIMockRecorder {
	return m.recorder
}

// List mocks base method.
func (m *MockFirewallPolicyIdpsSignaturesClientAPI) List(ctx context.Context, resourceGroupName, firewallPolicyName string, parameters network.IDPSQueryObject) (network.QueryResults, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", ctx, resourceGroupName, firewallPolicyName, parameters)
	ret0, _ := ret[0].(network.QueryResults)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// List indicates an expected call of List.
func (mr *MockFirewallPolicyIdpsSignaturesClientAPIMockRecorder) List(ctx, resourceGroupName, firewallPolicyName, parameters interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockFirewallPolicyIdpsSignaturesClientAPI)(nil).List), ctx, resourceGroupName, firewallPolicyName, parameters)
}

// MockFirewallPolicyIdpsSignaturesOverridesClientAPI is a mock of FirewallPolicyIdpsSignaturesOverridesClientAPI interface.
type MockFirewallPolicyIdpsSignaturesOverridesClientAPI struct {
	ctrl     *gomock.Controller
	recorder *MockFirewallPolicyIdpsSignaturesOverridesClientAPIMockRecorder
}

// MockFirewallPolicyIdpsSignaturesOverridesClientAPIMockRecorder is the mock recorder for MockFirewallPolicyIdpsSignaturesOverridesClientAPI.
type MockFirewallPolicyIdpsSignaturesOverridesClientAPIMockRecorder struct {
	mock *MockFirewallPolicyIdpsSignaturesOverridesClientAPI
}

// NewMockFirewallPolicyIdpsSignaturesOverridesClientAPI creates a new mock instance.
func NewMockFirewallPolicyIdpsSignaturesOverridesClientAPI(ctrl *gomock.Controller) *MockFirewallPolicyIdpsSignaturesOverridesClientAPI {
	mock := &MockFirewallPolicyIdpsSignaturesOverridesClientAPI{ctrl: ctrl}
	mock.recorder = &MockFirewallPolicyIdpsSignaturesOverridesClientAPIMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockFirewallPolicyIdpsSignaturesOverridesClientAPI) EXPECT() *MockFirewallPolicyIdpsSignaturesOverridesClientAPIMockRecorder {
	return m.recorder
}

// Get mocks base method.
func (m *MockFirewallPolicyIdpsSignaturesOverridesClientAPI) Get(ctx context.Context, resourceGroupName, firewallPolicyName string) (network.SignaturesOverrides, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, resourceGroupName, firewallPolicyName)
	ret0, _ := ret[0].(network.SignaturesOverrides)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Get indicates an expected call of Get.
func (mr *MockFirewallPolicyIdpsSignaturesOverridesClientAPIMockRecorder) Get(ctx, resourceGroupName, firewallPolicyName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockFirewallPolicyIdpsSignaturesOverridesClientAPI)(nil).Get), ctx, resourceGroupName, firewallPolicyName)
}

// List mocks base method.
func (m *MockFirewallPolicyIdpsSignaturesOverridesClientAPI) List(ctx context.Context, resourceGroupName, firewallPolicyName string) (network.SignaturesOverridesList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", ctx, resourceGroupName, firewallPolicyName)
	ret0, _ := ret[0].(network.SignaturesOverridesList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// List indicates an expected call of List.
func (mr *MockFirewallPolicyIdpsSignaturesOverridesClientAPIMockRecorder) List(ctx, resourceGroupName, firewallPolicyName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockFirewallPolicyIdpsSignaturesOverridesClientAPI)(nil).List), ctx, resourceGroupName, firewallPolicyName)
}

// Patch mocks base method.
func (m *MockFirewallPolicyIdpsSignaturesOverridesClientAPI) Patch(ctx context.Context, parameters network.SignaturesOverrides, resourceGroupName, firewallPolicyName string) (network.SignaturesOverrides, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Patch", ctx, parameters, resourceGroupName, firewallPolicyName)
	ret0, _ := ret[0].(network.SignaturesOverrides)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockFirewallPolicyIdpsSignaturesOverridesClientAPIMockRecorder) Patch(ctx, parameters, resourceGroupName, firewallPolicyName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Patch", reflect.TypeOf((*MockFirewallPolicyIdpsSignaturesOverridesClientAPI)(nil).Patch), ctx, parameters, resourceGroupName, firewallPolicyName)
}

// Put mocks base method.
func (m *MockFirewallPolicyIdpsSignaturesOverridesClientAPI) Put(ctx context.Context, parameters network.SignaturesOverrides, resourceGroupName, firewallPolicyName string) (network.SignaturesOverrides, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Put", ctx, parameters, resourceGroupName, firewallPolicyName)
	ret0, _ := ret[0].(network.SignaturesOverrides)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockFirewallPolicyIdpsSignaturesOverridesClientAPIMockRecorder) Put(ctx, parameters, resourceGroupName, firewallPolicyName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Put", reflect.TypeOf((*MockFirewallPolicyIdpsSignaturesOverridesClientAPI)(nil).Put), ctx, parameters, resourceGroupName, firewallPolicyName)
}

// MockFirewallPolicyIdpsSignaturesFilterValuesClientAPI is a mock of FirewallPolicyIdpsSignaturesFilterValuesClientAPI interface.
type MockFirewallPolicyIdpsSignaturesFilterValuesClientAPI struct {
	ctrl     *gomock.Controller
	recorder *MockFirewallPolicyIdpsSignaturesFilterValuesClientAPIMockRecorder
}

// MockFirewallPolicyIdpsSignaturesFilterValuesClientAPIMockRecorder is the mock recorder for MockFirewallPolicyIdpsSignaturesFilterValuesClientAPI.
type MockFirewallPolicyIdpsSignaturesFilterValuesClientAPIMockRecorder struct {
	mock *MockFirewallPolicyIdpsSignaturesFilterValuesClientAPI
}

// NewMockFirewallPolicyIdpsSignaturesFilterValuesClientAPI creates a new mock instance.
func NewMockFirewallPolicyIdpsSignaturesFilterValuesClientAPI(ctrl *gomock.Controller) *MockFirewallPolicyIdpsSignaturesFilterValuesClientAPI {
	mock := &MockFirewallPolicyIdpsSignaturesFilterValuesClientAPI{ctrl: ctrl}
	mock.recorder = &MockFirewallPolicyIdpsSignaturesFilterValuesClientAPIMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockFirewallPolicyIdpsSignaturesFilterValuesClientAPI) EXPECT() *MockFirewallPolicyIdpsSignaturesFilterValuesClientAPIMockRecorder {
	return m.recorder
}

// List mocks base method.
func (m *MockFirewallPolicyIdpsSignaturesFilterValuesClientAPI) List(ctx context.Context, parameters network.SignatureOverridesFilterValuesQuery, resourceGroupName, firewallPolicyName string) (network.SignatureOverridesFilterValuesResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", ctx, parameters, resourceGroupName, firewallPolicyName)
	ret0, _ := ret[0].(network.SignatureOverridesFilterValuesResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// List indicates an expected call of List.
func (mr *MockFirewallPolicyIdpsSignaturesFilterValuesClientAPIMockRecorder) List(ctx, parameters, resourceGroupName, firewallPolicyName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockFirewallPolicyIdpsSignaturesFilterValuesClientAPI)(nil).List), ctx, parameters, resourceGroupName, firewallPolicyName)
}
...
// ListInboundNatRulePortMappings mocks base method.
func (m *MockLoadBalancersClientAPI) ListInboundNatRulePortMappings(ctx context.Context, groupName, loadBalancerName, backendPoolName string, parameters network.QueryInboundNatRulePortMappingRequest) (network.LoadBalancersListInboundNatRulePortMappingsFuture, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListInboundNatRulePortMappings", ctx, groupName, loadBalancerName, backendPoolName, parameters)
	ret0, _ := ret[0].(network.LoadBalancersListInboundNatRulePortMappingsFuture)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListInboundNatRulePortMappings indicates an expected call of ListInboundNatRulePortMappings.
func (mr *MockLoadBalancersClientAPIMockRecorder) ListInboundNatRulePortMappings(ctx, groupName, loadBalancerName, backendPoolName, parameters interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListInboundNatRulePortMappings", reflect.TypeOf((*MockLoadBalancersClientAPI)(nil).ListInboundNatRulePortMappings), ctx, groupName, loadBalancerName, backendPoolName, parameters)
}

// SwapPublicIPAddresses mocks base method.
func (m *MockLoadBalancersClientAPI) SwapPublicIPAddresses(ctx context.Context, location string, parameters network.LoadBalancerVipSwapRequest) (network.LoadBalancersSwapPublicIPAddressesFuture, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SwapPublicIPAddresses", ctx, location, parameters)
	ret0, _ := ret[0].(network.LoadBalancersSwapPublicIPAddressesFuture)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// SwapPublicIPAddresses indicates an expected call of SwapPublicIPAddresses.
func (mr *MockLoadBalancersClientAPIMockRecorder) SwapPublicIPAddresses(ctx, location, parameters interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SwapPublicIPAddresses", reflect.TypeOf((*MockLoadBalancersClientAPI)(nil).SwapPublicIPAddresses), ctx, location, parameters)
}
...
// MockServiceTagInformationClientAPI is a mock of ServiceTagInformationClientAPI interface.
type MockServiceTagInformationClientAPI struct {
	ctrl     *gomock.Controller
	recorder *MockServiceTagInformationClientAPIMockRecorder
}

// MockServiceTagInformationClientAPIMockRecorder is the mock recorder for MockServiceTagInformationClientAPI.
type MockServiceTagInformationClientAPIMockRecorder struct {
	mock *MockServiceTagInformationClientAPI
}

// NewMockServiceTagInformationClientAPI creates a new mock instance.
func NewMockServiceTagInformationClientAPI(ctrl *gomock.Controller) *MockServiceTagInformationClientAPI {
	mock := &MockServiceTagInformationClientAPI{ctrl: ctrl}
	mock.recorder = &MockServiceTagInformationClientAPIMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockServiceTagInformationClientAPI) EXPECT() *MockServiceTagInformationClientAPIMockRecorder {
	return m.recorder
}

// List mocks base method.
func (m *MockServiceTagInformationClientAPI) List(ctx context.Context, location string, noAddressPrefixes *bool, tagName string) (network.ServiceTagInformationListResultPage, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", ctx, location, noAddressPrefixes, tagName)
	ret0, _ := ret[0].(network.ServiceTagInformationListResultPage)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// List indicates an expected call of List.
func (mr *MockServiceTagInformationClientAPIMockRecorder) List(ctx, location, noAddressPrefixes, tagName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockServiceTagInformationClientAPI)(nil).List), ctx, location, noAddressPrefixes, tagName)
}

// ListComplete mocks base method.
func (m *MockServiceTagInformationClientAPI) ListComplete(ctx context.Context, location string, noAddressPrefixes *bool, tagName string) (network.ServiceTagInformationListResultIterator, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListComplete", ctx, location, noAddressPrefixes, tagName)
	ret0, _ := ret[0].(network.ServiceTagInformationListResultIterator)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListComplete indicates an expected call of ListComplete.
func (mr *MockServiceTagInformationClientAPIMockRecorder) ListComplete(ctx, location, noAddressPrefixes, tagName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListComplete", reflect.TypeOf((*MockServiceTagInformationClientAPI)(nil).ListComplete), ctx, location, noAddressPrefixes, tagName)
}
...
// CreateOrUpdate mocks base method.
func (m *MockVirtualNetworkPeeringsClientAPI) CreateOrUpdate(ctx context.Context, resourceGroupName, virtualNetworkName, virtualNetworkPeeringName string, virtualNetworkPeeringParameters network.VirtualNetworkPeering, syncRemoteAddressSpace network.SyncRemoteAddressSpace) (network.VirtualNetworkPeeringsCreateOrUpdateFuture, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateOrUpdate", ctx, resourceGroupName, virtualNetworkName, virtualNetworkPeeringName, virtualNetworkPeeringParameters, syncRemoteAddressSpace)
...
// CreateOrUpdate indicates an expected call of CreateOrUpdate.
func (mr *MockVirtualNetworkPeeringsClientAPIMockRecorder) CreateOrUpdate(ctx, resourceGroupName, virtualNetworkName, virtualNetworkPeeringName, virtualNetworkPeeringParameters, syncRemoteAddressSpace interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateOrUpdate", reflect.TypeOf((*MockVirtualNetworkPeeringsClientAPI)(nil).CreateOrUpdate), ctx, resourceGroupName, virtualNetworkName, virtualNetworkPeeringName, virtualNetworkPeeringParameters, syncRemoteAddressSpace)
}
...
// GetIkeSas mocks base method.
func (m *MockVirtualNetworkGatewayConnectionsClientAPI) GetIkeSas(ctx context.Context, resourceGroupName, virtualNetworkGatewayConnectionName string) (network.VirtualNetworkGatewayConnectionsGetIkeSasFuture, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetIkeSas", ctx, resourceGroupName, virtualNetworkGatewayConnectionName)
	ret0, _ := ret[0].(network.VirtualNetworkGatewayConnectionsGetIkeSasFuture)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetIkeSas indicates an expected call of GetIkeSas.
func (mr *MockVirtualNetworkGatewayConnectionsClientAPIMockRecorder) GetIkeSas(ctx, resourceGroupName, virtualNetworkGatewayConnectionName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetIkeSas", reflect.TypeOf((*MockVirtualNetworkGatewayConnectionsClientAPI)(nil).GetIkeSas), ctx, resourceGroupName, virtualNetworkGatewayConnectionName)
}
...
// ResetConnection mocks base method.
func (m *MockVirtualNetworkGatewayConnectionsClientAPI) ResetConnection(ctx context.Context, resourceGroupName, virtualNetworkGatewayConnectionName string) (network.VirtualNetworkGatewayConnectionsResetConnectionFuture, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ResetConnection", ctx, resourceGroupName, virtualNetworkGatewayConnectionName)
	ret0, _ := ret[0].(network.VirtualNetworkGatewayConnectionsResetConnectionFuture)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ResetConnection indicates an expected call of ResetConnection.
func (mr *MockVirtualNetworkGatewayConnectionsClientAPIMockRecorder) ResetConnection(ctx, resourceGroupName, virtualNetworkGatewayConnectionName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ResetConnection", reflect.TypeOf((*MockVirtualNetworkGatewayConnectionsClientAPI)(nil).ResetConnection), ctx, resourceGroupName, virtualNetworkGatewayConnectionName)
}
...
// MockVirtualNetworkGatewayNatRulesClientAPI is a mock of VirtualNetworkGatewayNatRulesClientAPI interface.
type MockVirtualNetworkGatewayNatRulesClientAPI struct {
	ctrl     *gomock.Controller
	recorder *MockVirtualNetworkGatewayNatRulesClientAPIMockRecorder
}

// MockVirtualNetworkGatewayNatRulesClientAPIMockRecorder is the mock recorder for MockVirtualNetworkGatewayNatRulesClientAPI.
type MockVirtualNetworkGatewayNatRulesClientAPIMockRecorder struct {
	mock *MockVirtualNetworkGatewayNatRulesClientAPI
}

// NewMockVirtualNetworkGatewayNatRulesClientAPI creates a new mock instance.
func NewMockVirtualNetworkGatewayNatRulesClientAPI(ctrl *gomock.Controller) *MockVirtualNetworkGatewayNatRulesClientAPI {
	mock := &MockVirtualNetworkGatewayNatRulesClientAPI{ctrl: ctrl}
	mock.recorder = &MockVirtualNetworkGatewayNatRulesClientAPIMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockVirtualNetworkGatewayNatRulesClientAPI) EXPECT() *MockVirtualNetworkGatewayNatRulesClientAPIMockRecorder {
	return m.recorder
}

// CreateOrUpdate mocks base method.
func (m *MockVirtualNetworkGatewayNatRulesClientAPI) CreateOrUpdate(ctx context.Context, resourceGroupName, virtualNetworkGatewayName, natRuleName string, natRuleParameters network.VirtualNetworkGatewayNatRule) (network.VirtualNetworkGatewayNatRulesCreateOrUpdateFuture, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateOrUpdate", ctx, resourceGroupName, virtualNetworkGatewayName, natRuleName, natRuleParameters)
	ret0, _ := ret[0].(network.VirtualNetworkGatewayNatRulesCreateOrUpdateFuture)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateOrUpdate indicates an expected call of CreateOrUpdate.
func (mr *MockVirtualNetworkGatewayNatRulesClientAPIMockRecorder) CreateOrUpdate(ctx, resourceGroupName, virtualNetworkGatewayName, natRuleName, natRuleParameters interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateOrUpdate", reflect.TypeOf((*MockVirtualNetworkGatewayNatRulesClientAPI)(nil).CreateOrUpdate), ctx, resourceGroupName, virtualNetworkGatewayName, natRuleName, natRuleParameters)
}

// Delete mocks base method.
func (m *MockVirtualNetworkGatewayNatRulesClientAPI) Delete(ctx context.Context, resourceGroupName, virtualNetworkGatewayName, natRuleName string) (network.VirtualNetworkGatewayNatRulesDeleteFuture, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delete", ctx, resourceGroupName, virtualNetworkGatewayName, natRuleName)
	ret0, _ := ret[0].(network.VirtualNetworkGatewayNatRulesDeleteFuture)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Delete indicates an expected call of Delete.
func (mr *MockVirtualNetworkGatewayNatRulesClientAPIMockRecorder) Delete(ctx, resourceGroupName, virtualNetworkGatewayName, natRuleName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockVirtualNetworkGatewayNatRulesClientAPI)(nil).Delete), ctx, resourceGroupName, virtualNetworkGatewayName, natRuleName)
}

// Get mocks base method.
func (m *MockVirtualNetworkGatewayNatRulesClientAPI) Get(ctx context.Context, resourceGroupName, virtualNetworkGatewayName, natRuleName string) (network.VirtualNetworkGatewayNatRule, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, resourceGroupName, virtualNetworkGatewayName, natRuleName)
	ret0, _ := ret[0].(network.VirtualNetworkGatewayNatRule)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Get indicates an expected call of Get.
func (mr *MockVirtualNetworkGatewayNatRulesClientAPIMockRecorder) Get(ctx, resourceGroupName, virtualNetworkGatewayName, natRuleName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockVirtualNetworkGatewayNatRulesClientAPI)(nil).Get), ctx, resourceGroupName, virtualNetworkGatewayName, natRuleName)
}

// ListByVirtualNetworkGateway mocks base method.
func (m *MockVirtualNetworkGatewayNatRulesClientAPI) ListByVirtualNetworkGateway(ctx context.Context, resourceGroupName, virtualNetworkGatewayName string) (network.ListVirtualNetworkGatewayNatRulesResultPage, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListByVirtualNetworkGateway", ctx, resourceGroupName, virtualNetworkGatewayName)
	ret0, _ := ret[0].(network.ListVirtualNetworkGatewayNatRulesResultPage)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListByVirtualNetworkGateway indicates an expected call of ListByVirtualNetworkGateway.
func (mr *MockVirtualNetworkGatewayNatRulesClientAPIMockRecorder) ListByVirtualNetworkGateway(ctx, resourceGroupName, virtualNetworkGatewayName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListByVirtualNetworkGateway", reflect.TypeOf((*MockVirtualNetworkGatewayNatRulesClientAPI)(nil).ListByVirtualNetworkGateway), ctx, resourceGroupName, virtualNetworkGatewayName)
}

// ListByVirtualNetworkGatewayComplete mocks base method.
func (m *MockVirtualNetworkGatewayNatRulesClientAPI) ListByVirtualNetworkGatewayComplete(ctx context.Context, resourceGroupName, virtualNetworkGatewayName string) (network.ListVirtualNetworkGatewayNatRulesResultIterator, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListByVirtualNetworkGatewayComplete", ctx, resourceGroupName, virtualNetworkGatewayName)
	ret0, _ := ret[0].(network.ListVirtualNetworkGatewayNatRulesResultIterator)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListByVirtualNetworkGatewayComplete indicates an expected call of ListByVirtualNetworkGatewayComplete.
func (mr *MockVirtualNetworkGatewayNatRulesClientAPIMockRecorder) ListByVirtualNetworkGatewayComplete(ctx, resourceGroupName, virtualNetworkGatewayName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListByVirtualNetworkGatewayComplete", reflect.TypeOf((*MockVirtualNetworkGatewayNatRulesClientAPI)(nil).ListByVirtualNetworkGatewayComplete), ctx, resourceGroupName, virtualNetworkGatewayName)
}
...
// GetIkeSas mocks base method.
func (m *MockVpnLinkConnectionsClientAPI) GetIkeSas(ctx context.Context, resourceGroupName, gatewayName, connectionName, linkConnectionName string) (network.VpnLinkConnectionsGetIkeSasFuture, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetIkeSas", ctx, resourceGroupName, gatewayName, connectionName, linkConnectionName)
	ret0, _ := ret[0].(network.VpnLinkConnectionsGetIkeSasFuture)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetIkeSas indicates an expected call of GetIkeSas.
func (mr *MockVpnLinkConnectionsClientAPIMockRecorder) GetIkeSas(ctx, resourceGroupName, gatewayName, connectionName, linkConnectionName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetIkeSas", reflect.TypeOf((*MockVpnLinkConnectionsClientAPI)(nil).GetIkeSas), ctx, resourceGroupName, gatewayName, connectionName, linkConnectionName)
}
...
// ResetConnection mocks base method.
func (m *MockVpnLinkConnectionsClientAPI) ResetConnection(ctx context.Context, resourceGroupName, gatewayName, connectionName, linkConnectionName string) (network.VpnLinkConnectionsResetConnectionFuture, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ResetConnection", ctx, resourceGroupName, gatewayName, connectionName, linkConnectionName)
	ret0, _ := ret[0].(network.VpnLinkConnectionsResetConnectionFuture)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ResetConnection indicates an expected call of ResetConnection.
func (mr *MockVpnLinkConnectionsClientAPIMockRecorder) ResetConnection(ctx, resourceGroupName, gatewayName, connectionName, linkConnectionName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ResetConnection", reflect.TypeOf((*MockVpnLinkConnectionsClientAPI)(nil).ResetConnection), ctx, resourceGroupName, gatewayName, connectionName, linkConnectionName)
}
...
// MockNatRulesClientAPI is a mock of NatRulesClientAPI interface.
type MockNatRulesClientAPI struct {
	ctrl     *gomock.Controller
	recorder *MockNatRulesClientAPIMockRecorder
}

// MockNatRulesClientAPIMockRecorder is the mock recorder for MockNatRulesClientAPI.
type MockNatRulesClientAPIMockRecorder struct {
	mock *MockNatRulesClientAPI
}

// NewMockNatRulesClientAPI creates a new mock instance.
func NewMockNatRulesClientAPI(ctrl *gomock.Controller) *MockNatRulesClientAPI {
	mock := &MockNatRulesClientAPI{ctrl: ctrl}
	mock.recorder = &MockNatRulesClientAPIMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockNatRulesClientAPI) EXPECT() *MockNatRulesClientAPIMockRecorder {
	return m.recorder
}

// CreateOrUpdate mocks base method.
func (m *MockNatRulesClientAPI) CreateOrUpdate(ctx context.Context, resourceGroupName, gatewayName, natRuleName string, natRuleParameters network.VpnGatewayNatRule) (network.NatRulesCreateOrUpdateFuture, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateOrUpdate", ctx, resourceGroupName, gatewayName, natRuleName, natRuleParameters)
	ret0, _ := ret[0].(network.NatRulesCreateOrUpdateFuture)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateOrUpdate indicates an expected call of CreateOrUpdate.
func (mr *MockNatRulesClientAPIMockRecorder) CreateOrUpdate(ctx, resourceGroupName, gatewayName, natRuleName, natRuleParameters interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateOrUpdate", reflect.TypeOf((*MockNatRulesClientAPI)(nil).CreateOrUpdate), ctx, resourceGroupName, gatewayName, natRuleName, natRuleParameters)
}

// Delete mocks base method.
func (m *MockNatRulesClientAPI) Delete(ctx context.Context, resourceGroupName, gatewayName, natRuleName string) (network.NatRulesDeleteFuture, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delete", ctx, resourceGroupName, gatewayName, natRuleName)
	ret0, _ := ret[0].(network.NatRulesDeleteFuture)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Delete indicates an expected call of Delete.
func (mr *MockNatRulesClientAPIMockRecorder) Delete(ctx, resourceGroupName, gatewayName, natRuleName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockNatRulesClientAPI)(nil).Delete), ctx, resourceGroupName, gatewayName, natRuleName)
}

// Get mocks base method.
func (m *MockNatRulesClientAPI) Get(ctx context.Context, resourceGroupName, gatewayName, natRuleName string) (network.VpnGatewayNatRule, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, resourceGroupName, gatewayName, natRuleName)
	ret0, _ := ret[0].(network.VpnGatewayNatRule)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Get indicates an expected call of Get.
func (mr *MockNatRulesClientAPIMockRecorder) Get(ctx, resourceGroupName, gatewayName, natRuleName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockNatRulesClientAPI)(nil).Get), ctx, resourceGroupName, gatewayName, natRuleName)
}

// ListByVpnGateway mocks base method.
func (m *MockNatRulesClientAPI) ListByVpnGateway(ctx context.Context, resourceGroupName, gatewayName string) (network.ListVpnGatewayNatRulesResultPage, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListByVpnGateway", ctx, resourceGroupName, gatewayName)
	ret0, _ := ret[0].(network.ListVpnGatewayNatRulesResultPage)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListByVpnGateway indicates an expected call of ListByVpnGateway.
func (mr *MockNatRulesClientAPIMockRecorder) ListByVpnGateway(ctx, resourceGroupName, gatewayName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListByVpnGateway", reflect.TypeOf((*MockNatRulesClientAPI)(nil).ListByVpnGateway), ctx, resourceGroupName, gatewayName)
}

// ListByVpnGatewayComplete mocks base method.
func (m *MockNatRulesClientAPI) ListByVpnGatewayComplete(ctx context.Context, resourceGroupName, gatewayName string) (network.ListVpnGatewayNatRulesResultIterator, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListByVpnGatewayComplete", ctx, resourceGroupName, gatewayName)
	ret0, _ := ret[0].(network.ListVpnGatewayNatRulesResultIterator)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListByVpnGatewayComplete indicates an expected call of ListByVpnGatewayComplete.
func (mr *MockNatRulesClientAPIMockRecorder) ListByVpnGatewayComplete(ctx, resourceGroupName, gatewayName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListByVpnGatewayComplete", reflect.TypeOf((*MockNatRulesClientAPI)(nil).ListByVpnGatewayComplete), ctx, resourceGroupName, gatewayName)
}
...
// UpdateTags mocks base method.
func (m *MockExpressRouteGatewaysClientAPI) UpdateTags(ctx context.Context, resourceGroupName, expressRouteGatewayName string, expressRouteGatewayParameters network.TagsObject) (network.ExpressRouteGatewaysUpdateTagsFuture, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateTags", ctx, resourceGroupName, expressRouteGatewayName, expressRouteGatewayParameters)
	ret0, _ := ret[0].(network.ExpressRouteGatewaysUpdateTagsFuture)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdateTags indicates an expected call of UpdateTags.
func (mr *MockExpressRouteGatewaysClientAPIMockRecorder) UpdateTags(ctx, resourceGroupName, expressRouteGatewayName, expressRouteGatewayParameters interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateTags", reflect.TypeOf((*MockExpressRouteGatewaysClientAPI)(nil).UpdateTags), ctx, resourceGroupName, expressRouteGatewayName, expressRouteGatewayParameters)
}
...
// MockRoutingIntentClientAPI is a mock of RoutingIntentClientAPI interface.
type MockRoutingIntentClientAPI struct {
	ctrl     *gomock.Controller
	recorder *MockRoutingIntentClientAPIMockRecorder
}

// MockRoutingIntentClientAPIMockRecorder is the mock recorder for MockRoutingIntentClientAPI.
type MockRoutingIntentClientAPIMockRecorder struct {
	mock *MockRoutingIntentClientAPI
}

// NewMockRoutingIntentClientAPI creates a new mock instance.
func NewMockRoutingIntentClientAPI(ctrl *gomock.Controller) *MockRoutingIntentClientAPI {
	mock := &MockRoutingIntentClientAPI{ctrl: ctrl}
	mock.recorder = &MockRoutingIntentClientAPIMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockRoutingIntentClientAPI) EXPECT() *MockRoutingIntentClientAPIMockRecorder {
	return m.recorder
}

// CreateOrUpdate mocks base method.
func (m *MockRoutingIntentClientAPI) CreateOrUpdate(ctx context.Context, resourceGroupName, virtualHubName, routingIntentName string, routingIntentParameters network.RoutingIntent) (network.RoutingIntentCreateOrUpdateFuture, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateOrUpdate", ctx, resourceGroupName, virtualHubName, routingIntentName, routingIntentParameters)
	ret0, _ := ret[0].(network.RoutingIntentCreateOrUpdateFuture)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateOrUpdate indicates an expected call of CreateOrUpdate.
func (mr *MockRoutingIntentClientAPIMockRecorder) CreateOrUpdate(ctx, resourceGroupName, virtualHubName, routingIntentName, routingIntentParameters interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateOrUpdate", reflect.TypeOf((*MockRoutingIntentClientAPI)(nil).CreateOrUpdate), ctx, resourceGroupName, virtualHubName, routingIntentName, routingIntentParameters)
}

// Delete mocks base method.
func (m *MockRoutingIntentClientAPI) Delete(ctx context.Context, resourceGroupName, virtualHubName, routingIntentName string) (network.RoutingIntentDeleteFuture, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delete", ctx, resourceGroupName, virtualHubName, routingIntentName)
	ret0, _ := ret[0].(network.RoutingIntentDeleteFuture)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Delete indicates an expected call of Delete.
func (mr *MockRoutingIntentClientAPIMockRecorder) Delete(ctx, resourceGroupName, virtualHubName, routingIntentName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockRoutingIntentClientAPI)(nil).Delete), ctx, resourceGroupName, virtualHubName, routingIntentName)
}

// Get mocks base method.
func (m *MockRoutingIntentClientAPI) Get(ctx context.Context, resourceGroupName, virtualHubName, routingIntentName string) (network.RoutingIntent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, resourceGroupName, virtualHubName, routingIntentName)
	ret0, _ := ret[0].(network.RoutingIntent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Get indicates an expected call of Get.
func (mr *MockRoutingIntentClientAPIMockRecorder) Get(ctx, resourceGroupName, virtualHubName, routingIntentName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockRoutingIntentClientAPI)(nil).Get), ctx, resourceGroupName, virtualHubName, routingIntentName)
}

// List mocks base method.
func (m *MockRoutingIntentClientAPI) List(ctx context.Context, resourceGroupName, virtualHubName string) (network.ListRoutingIntentResultPage, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", ctx, resourceGroupName, virtualHubName)
	ret0, _ := ret[0].(network.ListRoutingIntentResultPage)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// List indicates an expected call of List.
func (mr *MockRoutingIntentClientAPIMockRecorder) List(ctx, resourceGroupName, virtualHubName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockRoutingIntentClientAPI)(nil).List), ctx, resourceGroupName, virtualHubName)
}

// ListComplete mocks base method.
func (m *MockRoutingIntentClientAPI) ListComplete(ctx context.Context, resourceGroupName, virtualHubName string) (network.ListRoutingIntentResultIterator, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListComplete", ctx, resourceGroupName, virtualHubName)
	ret0, _ := ret[0].(network.ListRoutingIntentResultIterator)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListComplete indicates an expected call of ListComplete.
func (mr *MockRoutingIntentClientAPIMockRecorder) ListComplete(ctx, resourceGroupName, virtualHubName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListComplete", reflect.TypeOf((*MockRoutingIntentClientAPI)(nil).ListComplete), ctx, resourceGroupName, virtualHubName)
}
