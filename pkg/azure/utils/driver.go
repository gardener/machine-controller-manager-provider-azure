...
func ExtractProviderSpecAndConnectConfig(mcc *v1alpha1.MachineClass, secret *corev1.Secret) (*api.AzureProviderSpec, *azure.ConnectConfig, error) {
	var (
		err           error
		providerSpec  *api.AzureProviderSpec
		connectConfig *azure.ConnectConfig
	)
