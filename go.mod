...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/azidentity v1.4.0-beta.4
	...
	github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/network/armnetwork/v4 v4.1.0-beta.1
